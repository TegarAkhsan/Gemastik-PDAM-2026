  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-6 relative z-10">
        ...
        <div className="hero-card p-4 mb-8 text-white relative">
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-4">
              <div>
                <p className="text-blue-100 text-[10px] uppercase tracking-widest font-bold mb-1">Informasi Pelanggan</p>
                <h3 className="font-bold text-lg leading-tight mb-1">Savannah Nguyen</h3>
                <p className="text-white text-[10px] font-semibold opacity-90 font-mono bg-black/10 px-2 py-0.5 rounded inline-block">ID: 1234 5678 9012</p>
              </div>
              <div className="bg-white/20 backdrop-blur-md rounded-[10px] p-1.5 px-2.5 flex items-center gap-1.5 border border-white/20">
                ...
                <span className="font-bold text-[10px] uppercase tracking-wider">Aktif</span>
              </div>
            </div>
            
            <div className="glass-panel p-4">
              <p className="text-blue-50 text-[11px] font-semibold mb-1">Tagihan Bulan Ini</p>
              <h2 className="font-extrabold text-2xl mb-2 tracking-tight">Rp 0</h2>
              <div className="flex items-center gap-2 text-white/90 text-[11px] font-medium bg-white/10 px-2.5 py-1.5 rounded-md">
                <FileText className="text-blue-100 w-4 h-4" /> 
                <span>Belum ada tagihan yang terbit</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div 
          className="mb-6 bg-gradient-to-r from-[#e6f4ff] to-blue-50 border border-blue-100 rounded-[14px] p-3 shadow-sm flex items-center justify-between cursor-pointer" 
          onClick={() => togglePopup('popup-catat-meter')}
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#2a81d4] shadow-sm border border-blue-50">
              <CalendarCheck className="w-5 h-5" />
            </div>
            <div>
              <p className="text-[9px] font-extrabold text-[#2a81d4] uppercase tracking-widest mb-0.5">Jadwal Catat Mandiri</p>
              <h4 className="text-xs font-bold text-blue-900 leading-tight">Berlangsung: <span className="font-extrabold">15-20 Juli</span></h4>
            </div>
          </div>
          <div className="bg-green-500 text-white text-[9px] font-extrabold px-2.5 py-1.5 rounded-lg shadow-sm animate-pulse">
            Aktif
          </div>
        </div>
    ...
    <>
      ...
      <div className="flex-1 px-5 pt-4 pb-8 flex flex-col relative z-10 gap-5">
        ...
        <div className="flex-1 flex flex-col items-center justify-center mt-10">
          ...
          <div className="bg-[#fef3c7] text-[#92400e] text-[11px] font-extrabold px-4 py-2.5 rounded-xl border border-[#fde68a] shadow-sm">
            Silahkan pilih nomor pelanggan
          </div>
        </div>
      </div>
    </>
    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 pt-4 pb-10 flex flex-col gap-5">
        <div className="bg-gray-100/80 p-1.5 rounded-[18px] flex items-center mx-auto w-[280px] border border-gray-200/50">
          <button className="flex-1 bg-white text-[#2a81d4] text-[11px] font-bold py-2.5 rounded-2xl shadow-sm transition">Catat Meter</button>
          <button className="flex-1 text-gray-500 hover:text-gray-700 text-[11px] font-semibold py-2.5 rounded-2xl transition">Riwayat</button>
        </div>
        ...
        <button className="w-full bg-[#2a81d4] text-white text-[13px] font-extrabold py-3.5 rounded-2xl flex justify-center items-center gap-2 shadow-[0_8px_20px_rgba(42,129,212,0.25)] hover:bg-[#1f6db8] transition-all">
    ...
    <>
      ...
      <div className="flex-1 px-5 pt-4 flex flex-col gap-4 overflow-y-auto hide-scrollbar">
        ...
        {subTab === 'baru' ? (
          ...
          <div className="flex flex-col items-center gap-4 animate-fade-in w-full h-full pt-10">
            <div className="relative w-full max-w-xs mb-8">
              <input type="text" placeholder="Nomor pasang baru / telepon" className="w-full bg-white text-gray-800 text-[12px] font-bold px-5 py-4 pr-14 rounded-2xl outline-none focus:ring-2 focus:ring-[#47c4f4]/30 shadow-md border border-gray-100 transition-all" />
            ...
            <div className="flex-1 flex flex-col items-center justify-center pt-5">
              <div className="w-24 h-24 bg-blue-50 text-[#47c4f4] rounded-full flex items-center justify-center text-4xl mb-6 shadow-sm border border-blue-100">
                <ClipboardCheck className="w-10 h-10 text-blue-400" />
              </div>
              <div className="bg-[#fef3c7] text-[#92400e] text-[11px] font-extrabold px-6 py-2.5 rounded-xl shadow-sm text-center">
                Cek status pengajuan pasang baru Anda
              </div>
            </div>
          </div>
        )}
    ...
    <>
      ...
      <div className="flex-1 px-5 pt-4 pb-24 flex flex-col gap-4 overflow-y-auto hide-scrollbar relative">
        ...
        {subTab === 'baru' ? (
          ...
          <div className="flex flex-col items-center gap-4 animate-fade-in w-full h-full pb-20">
            <select className="modern-input custom-select text-gray-500 w-full mb-10">
              <option value="" disabled selected>Pilih nomor pelanggan</option>
              <option value="1">123456789 - John Doe</option>
            </select>
            ...
            <div className="flex-1 flex flex-col items-center justify-center pt-10">
              <div className="w-24 h-24 bg-blue-50 text-[#47c4f4] rounded-full flex items-center justify-center text-4xl mb-6 shadow-sm border border-blue-100">
                <Droplet className="text-blue-400 w-10 h-10" />
              </div>
              <div className="bg-[#fef3c7] text-[#92400e] text-[11px] font-extrabold px-6 py-2.5 rounded-xl shadow-sm">
                Pilih nomor pelanggan anda
              </div>
            </div>
          </div>
        )}
